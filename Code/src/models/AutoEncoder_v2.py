...
def AutoEncoder(img, filters=32, kernel_size=3, padding='same',
    ...
    out = DownBlock(out, filters*2*2*2*2, kernel_size, padding, activation, kernel_initializer)
    out = DownBlock(out, filters*2*2*2*2*2, kernel_size, padding, activation, kernel_initializer)


    out = BridgeBlock(out, filters*2*2*2*2*2*2, kernel_size, padding, activation, kernel_initializer)
